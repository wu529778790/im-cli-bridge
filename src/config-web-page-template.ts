              ...
              <div class="platform-card">
                ...
                <div class="platform-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="telegram-botToken" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
                    <label class="form-label" id="telegram-proxy-label">Proxy (optional)</label>
                    <input id="telegram-proxy" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
              ...
              <div class="platform-card">
                ...
                <div class="platform-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="feishu-appSecret" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
              ...
              <div class="platform-card">
                ...
                <div class="platform-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="qq-secret" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
              ...
              <div class="platform-card">
                ...
                <div class="platform-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="wework-secret" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
              ...
              <div class="platform-card">
                ...
                <div class="platform-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="dingtalk-clientId" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
                    <label class="form-label" id="dingtalk-clientSecret-label">Client Secret / AppSecret</label>
                    <input id="dingtalk-clientSecret" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
                    <label class="form-label" id="dingtalk-cardTemplateId-label">Card Template ID (optional)</label>
                    <input id="dingtalk-cardTemplateId" class="form-input mono" type="text" />
                  </div>
                  <div class="form-group">
