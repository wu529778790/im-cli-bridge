...
- `open-im start` also serves the local config page
- `open-im dev` only auto-opens the page when setup is still incomplete
- If config already exists and you want to open it manually, use `open-im start`
